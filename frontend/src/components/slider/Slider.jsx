  ...
  return (
    <section className="slider">
      <div className="slider-elements">
        {currentSlide === 0 && (
          <SliderItem imageSrc="img/slider/slider1.jpg"></SliderItem>
        )}
        {currentSlide === 1 && (
          <SliderItem imageSrc="img/slider/slider2.jpg"></SliderItem>
        )}
        {currentSlide === 2 && (
          <SliderItem imageSrc="img/slider/slider3.jpg"></SliderItem>
        )}
